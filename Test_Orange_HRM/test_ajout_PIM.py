...
class Test(unittest.TestCase):
    ...
    def test_case_ajouter_pim(self):
        driver = self.driver
        ...
        driver.find_element(By.XPATH, "//div[@id='app']/div/div[2]/div[2]/div/div/form/div/div[2]/div/div[2]/div/div/div[2]/input").send_keys("")
        driver.find_element(By.XPATH, "//button[@type='submit']").click()
        ...
        while True:
            ...
            employes_list = driver.find_elements(
                By.CLASS_NAME, "oxd-table-card")
            ...
            print(f'Page actuelle: {count_on_page} éléments sur la premiere page | Total jusqu à présent: {
                  total_count} éléments')
            ...
            next_page_button = self.driver.find_element(
                By.XPATH, "//button[@class='oxd-pagination-page-item oxd-pagination-page-item--previous-next']")
            # next_page_button.click()
            elements = driver.find_elements(
                By.XPATH, "//button[@class='oxd-pagination-page-item oxd-pagination-page-item--previous-next']/i[@class='oxd-icon bi-chevron-right']")

            # //ul[@class='oxd-pagination__ul']/li
            elementsCount = driver.find_elements(
                By.XPATH, "//ul[@class='oxd-pagination__ul']/li")
